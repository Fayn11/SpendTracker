...
class NewAccountForm(forms.ModelForm):          # forms.Form
    ...
    class Meta:
        ...
        widgets = {
            ...
            'email': TextInput(attrs={'placeholder': 'Introduceti Emailul', 'class': 'form-control'}),
            'username': TextInput(attrs={'placeholder': 'Introduceti UserNameul', 'class': 'form-control'})
        }
